        ...
        <Popover className="relative">
            <Popover.Button className='py-[3px] block group outline-none'>
                ...
                <div className={' p-3 rounded-full inline-flex transition-colors items-center gap-3 group-hover:bg-[color:var(--background-third)] z-50'}>
                    ...
                    <div className='text-xl px-4 flex justify-center items-center'>
                        Daha Fazla
                    </div>
                </div>
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] rounded-xl shadow-box overflow-hidden ">
                ...
                <Disclosure>
                    {({ open }) => (
                        <>
                            <Disclosure.Button className="w-full h-[52px] flex justify-between items-center px-4 transition-colors font-bold hover:bg-[color:var(--background-secondary)]">
                                İçerik Stüdyosu
                ...
                <Disclosure>
                    {({ open }) => (
                        <>
                            ...
                            <Disclosure.Panel >
                                <Link to="/" className='flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[color:var(--background-secondary)] transition-color'>
                                    <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                                        <path
                                            fill='currentColor'
                    ...
                    {({ open }) => (
                        <>
                            ...
                            <Disclosure.Panel >
                                ...
                                <button onClick={() => setModal("apperance")} className='w-full flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[color:var(--background-secondary)] transition-colors'>
                                    <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                                        <path
                                            fill='currentColor'
